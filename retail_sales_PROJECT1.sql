...
-- Checking duplcate with Group by
...
-- Another way to check for duplicate if the data does not have a unique identifier
...
-- step 2: use the code in step1 to create a CTE
...
-- All these method requires me to write the column name one by one 
-- so those methods are not effective, Python will help better
...
-- Write a SQL query to retrieve total sales made on '2022-11-05:
